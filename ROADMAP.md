...
- [x] Depth-confounded calibration dashboards (statistician-first; avoids clutter):
  ...
  - [x] focused filter: `signal_depth`-equivalent (no batch/offtarget/overdispersion) with `treatment_depth_multiplier=10`
  - [x] writes under suite: `figures/calibration_depthconfounded/resp=<...>/`
